"""DeepSeek LLM provider using the openai SDK with DeepSeek base URL."""
...
class DeepSeekLLM(BaseLLM):
    ...
    Uses the OpenAI SDK pointed at the DeepSeek API endpoint.
    ...
    def chat(
        ...
        *,
        ...
        try:
            ...
            raise RuntimeError(f"DeepSeek chat request failed: {exc}") from exc
